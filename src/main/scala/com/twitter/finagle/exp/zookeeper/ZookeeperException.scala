...
case class RuntimeInconsistencyException(msg: String)
  extends ZookeeperException(msg)

/** A data inconsistency was found */
case class DataInconsistencyException(msg: String)
  extends ZookeeperException(msg)
...
case class MarshallingErrorException(msg: String)
  extends ZookeeperException(msg)
...
/** Operation timeout */
case class OperationTimeoutException(msg: String)
  extends ZookeeperException(msg)
...
/** No quorum of new config is connected and up-to-date with the leader
  * of last committed config - try invoking reconfiguration after new servers
  * are connected and synced */
case class NewConfigNoQuorumException(msg: String)
  extends ZookeeperException(msg)

/** Another reconfiguration is in progress
  * -- concurrent reconfigs not supported (yet) */
case class ReconfigInProgressException(msg: String)
  extends ZookeeperException(msg)
...
// No problem exception, used during Transaction
...
case class NoChildrenForEphemeralsException(msg: String)
  extends ZookeeperException(msg)
...
case class EphemeralOnLocalSessionException(msg: String)
  extends ZookeeperException(msg)
...
object ZookeeperException {
  ...
  def create(msg: String, code: Int): ZookeeperException = code match {
    ...
    case -2 => new RuntimeInconsistencyException(msg + " " +
    ...
    case -13 => new NewConfigNoQuorumException(msg + " " +
      ...
      "and up-to-date with the leader of last committed config")
    case -14 => new ReconfigInProgressException(msg + " " +
      "Another reconfiguration is in progress")
    ...
    case -108 => new NoChildrenForEphemeralsException(msg + " " +
    ...
    case -115 => new AuthFailedException(msg + " " +
      "Authentication has failed")
    case -118 => new SessionMovedException(msg + " " + "Session has moved")
    case -119 => new NotReadOnlyException(msg + " " +
      "This server does not support Read Only")
    case -120 => new EphemeralOnLocalSessionException(msg + " " +
      "Attempt to create ephemeral node on a local session")
    case -121 => new NoWatcherException(msg + " " +
      "Attempts to remove a non-existing watcher")
  }
}